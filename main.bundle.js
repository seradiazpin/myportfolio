...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__skill_component_skill_service__ = __webpack_require__(51);
...
var SkillsComponent = (function () {
    ...
    SkillsComponent.prototype.getFrontSkills = function () {
        var _this = this;
        this.skillsService.getFrontData().then(function (skills) { return _this.fskills = skills; });
    };
    SkillsComponent.prototype.getBackSkills = function () {
        var _this = this;
        this.skillsService.getBackData().then(function (skills) { return _this.bskills = skills; });
    };
    SkillsComponent.prototype.getToolsSkills = function () {
        var _this = this;
        this.skillsService.getToolsData().then(function (skills) { return _this.tskills = skills; });
    };
    SkillsComponent.prototype.getLangSkills = function () {
        var _this = this;
        this.skillsService.getLangData().then(function (skills) { return _this.lskills = skills; });
    };
...
SkillsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__skill_component_skill_service__["a" /* SkillsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__skill_component_skill_service__["a" /* SkillsService */]) === "function" && _a || Object])
], SkillsComponent);
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col s12 m8 push-m2\">\r\n    <div class=\"card\">\r\n      \r\n      <div class=\"card-content\">\r\n        <p >\r\n          Ingeniero de Sistemas y Computación de la Universidad Nacional de Colombia. Con experiencia\r\n          en el desarrollo de componentes de software y de base de datos para sistemas informáticos\r\n          empresariales pequeños y uso de herramientas enfocadas al desarrollo con enfoque ágil.\r\n        </p>\r\n      <br>\r\n        <p>\r\n          Gran interés por aprender, buenas relaciones interpersonales, así como capacidades para liderar\r\n          y trabajar en equipo. Conocimientos adquiridos en el transcurso de la carrera y por cuenta propia\r\n          principalmente sobre programación orientada a objetos, desarrollo de software, metodologías\r\n          agiles, bases de datos, APIS y arquitectura de software.\r\n          </p>\r\n        <a href=\"assets/doc/Sergio Alejandro Diaz Pinilla-HV.pdf\">Hoja de vida</a>\r\n      </div>\r\n      <div class=\"card-action row\">\r\n        <div class=\"col s4 m4 center-align\">\r\n          <a href=\"https://github.com/seradiazpin\" target=\"_blank\">\r\n            <svg viewBox=\"0 0 128 128\" style=\"width: 50%\" >\r\n            <path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M64 5.103c-33.347 0-60.388 27.035-60.388 60.388 0 26.682 17.303 49.317 41.297 57.303 3.017.56 4.125-1.31 4.125-2.905 0-1.44-.056-6.197-.082-11.243-16.8 3.653-20.345-7.125-20.345-7.125-2.747-6.98-6.705-8.836-6.705-8.836-5.48-3.748.413-3.67.413-3.67 6.063.425 9.257 6.223 9.257 6.223 5.386 9.23 14.127 6.562 17.573 5.02.542-3.903 2.107-6.568 3.834-8.076-13.413-1.525-27.514-6.704-27.514-29.843 0-6.593 2.36-11.98 6.223-16.21-.628-1.52-2.695-7.662.584-15.98 0 0 5.07-1.623 16.61 6.19C53.7 35 58.867 34.327 64 34.304c5.13.023 10.3.694 15.127 2.033 11.526-7.813 16.59-6.19 16.59-6.19 3.287 8.317 1.22 14.46.593 15.98 3.872 4.23 6.215 9.617 6.215 16.21 0 23.194-14.127 28.3-27.574 29.796 2.167 1.874 4.097 5.55 4.097 11.183 0 8.08-.07 14.583-.07 16.572 0 1.607 1.088 3.49 4.148 2.897 23.98-7.994 41.263-30.622 41.263-57.294C124.388 32.14 97.35 5.104 64 5.104z\"></path><path d=\"M26.484 91.806c-.133.3-.605.39-1.035.185-.44-.196-.685-.605-.543-.906.13-.31.603-.395 1.04-.188.44.197.69.61.537.91zm-.743-.55M28.93 94.535c-.287.267-.85.143-1.232-.28-.396-.42-.47-.983-.177-1.254.298-.266.844-.14 1.24.28.394.426.472.984.17 1.255zm-.575-.618M31.312 98.012c-.37.258-.976.017-1.35-.52-.37-.538-.37-1.183.01-1.44.373-.258.97-.025 1.35.507.368.545.368 1.19-.01 1.452zm0 0M34.573 101.373c-.33.365-1.036.267-1.552-.23-.527-.487-.674-1.18-.343-1.544.336-.366 1.045-.264 1.564.23.527.486.686 1.18.333 1.543zm0 0M39.073 103.324c-.147.473-.825.688-1.51.486-.683-.207-1.13-.76-.99-1.238.14-.477.823-.7 1.512-.485.683.206 1.13.756.988 1.237zm0 0M44.016 103.685c.017.498-.563.91-1.28.92-.723.017-1.308-.387-1.315-.877 0-.503.568-.91 1.29-.924.717-.013 1.306.387 1.306.88zm0 0M48.614 102.903c.086.485-.413.984-1.126 1.117-.7.13-1.35-.172-1.44-.653-.086-.498.422-.997 1.122-1.126.714-.123 1.354.17 1.444.663zm0 0\"></path>\r\n            </svg>\r\n            <h5>Github</h5>\r\n          </a>\r\n        </div>\r\n\r\n        <div class=\"col s4 m4 center-align\">\r\n          <a href=\"https://www.linkedin.com/in/seradiazpin/\" target=\"_blank\">\r\n            <svg viewBox=\"0 0 300 300\" style=\"width: 50%\" fill=\"blue\" >\r\n              <path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M277.792814,0 L22.1430112,0 C9.92675211,0 0,9.68301024 0,21.6159454 L0,278.344879 C0,290.290314 9.92675211,299.98999 22.1430112,299.98999 L277.792814,299.98999 C290.029906,299.98999 299.998323,290.292397 299.998323,278.344879 L299.998323,21.6159454 C299.998323,9.68301024 290.029906,0 277.792814,0 Z M44.4797658,112.464997 L88.9761978,112.464997 L88.9761978,255.631054 L44.4797658,255.631054 L44.4797658,112.464997 Z M66.7373565,41.3007053 C80.9618819,41.3007053 92.5219128,52.8607362 92.5219128,67.0915114 C92.5219128,81.3347861 80.9618819,92.894817 66.7373565,92.894817 C52.4753324,92.894817 40.9319676,81.3347861 40.9319676,67.0915114 C40.9340508,52.8628195 52.4774157,41.3007053 66.7373565,41.3007053 Z M116.885683,112.464997 L159.561343,112.464997 L159.561343,132.026845 L160.157156,132.026845 C166.098624,120.77097 180.61064,108.9047 202.257835,108.9047 C247.314665,108.9047 255.633137,138.557877 255.633137,177.102424 L255.633137,255.62897 L211.167954,255.62897 L211.167954,186.006294 C211.167954,169.404764 210.863797,148.049227 188.045809,148.049227 C164.894498,148.049227 161.34045,166.13404 161.34045,184.806334 L161.34045,255.62897 L116.8836,255.62897 L116.8836,112.464997 L116.885683,112.464997 Z\"></path></svg>\r\n            <h5>LinkIn</h5>\r\n          </a>\r\n        </div>\r\n        <div class=\"col s4 m4 center-align\" >\r\n          <a href=\"https://plus.google.com/u/1/116540179647935114350\" target=\"_blank\">\r\n            <svg viewBox=\"0 0 128 128\" style=\"width: 50%\" fill=\"#FF0000\">\r\n              <path   d=\"M44.59,4.21a63.28,63.28,0,0,0,4.33,120.9,67.6,67.6,0,0,0,32.36.35A57.13,57.13,0,0,0,107.18,112a57.44,57.44,0,0,0,16-26.26,74.33,74.33,0,0,0,1.61-33.58H65.27c0,8.23,0,16.46,0,24.69H99.74A29.72,29.72,0,0,1,87.08,96.37a36.16,36.16,0,0,1-13.93,5.5,41.29,41.29,0,0,1-15.1,0A37.16,37.16,0,0,1,44,95.74a39.3,39.3,0,0,1-14.5-19.42,38.31,38.31,0,0,1,0-24.63,39.25,39.25,0,0,1,9.18-14.91A37.17,37.17,0,0,1,76.13,27a34.28,34.28,0,0,1,13.64,8q5.83-5.8,11.64-11.63c2-2.09,4.18-4.08,6.15-6.22A61.22,61.22,0,0,0,87.2,4.59,64,64,0,0,0,44.59,4.21Z\"></path><path class=\"yellow\" d=\"M44.59,4.21a64,64,0,0,1,42.61.37A61.22,61.22,0,0,1,107.55,17.2c-2,2.14-4.11,4.14-6.15,6.22Q95.58,29.23,89.77,35a34.28,34.28,0,0,0-13.64-8,37.17,37.17,0,0,0-37.46,9.74,39.25,39.25,0,0,0-9.18,14.91L8.76,35.6A63.53,63.53,0,0,1,44.59,4.21Z\"></path><path class=\"blue\" d=\"M3.26,51.5a62.93,62.93,0,0,1,5.5-15.9L29.49,51.69a38.31,38.31,0,0,0,0,24.63q-10.36,8-20.73,16.08A63.33,63.33,0,0,1,3.26,51.5Z\"></path><path class=\"cls-4\" d=\"M65.27,52.15h59.52a74.33,74.33,0,0,1-1.61,33.58,57.44,57.44,0,0,1-16,26.26c-6.69-5.22-13.41-10.4-20.1-15.62A29.72,29.72,0,0,0,99.74,76.83H65.27C65.26,68.61,65.27,60.38,65.27,52.15Z\"></path><path class=\"green\" d=\"M8.75,92.4q10.37-8,20.73-16.08A39.3,39.3,0,0,0,44,95.74a37.16,37.16,0,0,0,14.08,6.08,41.29,41.29,0,0,0,15.1,0,36.16,36.16,0,0,0,13.93-5.5c6.69,5.22,13.41,10.4,20.1,15.62a57.13,57.13,0,0,1-25.9,13.47,67.6,67.6,0,0,1-32.36-.35,63,63,0,0,1-23-11.59A63.73,63.73,0,0,1,8.75,92.4Z\"></path>\r\n            </svg>\r\n            <h5>Google</h5>\r\n          </a>\r\n        </div>\r\n\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"col s12 m8 push-m2\">\r\n  <ul id=\"tabs-swipe-demo\" class=\"tabs\">\r\n    <li class=\"tab col s3 waves-effect waves-red\"><a class=\"active\" href=\"#test-swipe-1\">Estudios</a></li>\r\n    <li class=\"tab col s3 waves-effect waves-red\"><a  href=\"#test-swipe-2\">Idiomas</a></li>\r\n  </ul>\r\n  <div id=\"test-swipe-1\" class=\"col s12 card \">\r\n    <div class=\"row\">\r\n      <h4>FORMACIÓN ACADÉMICA</h4>\r\n      <h5>Universitarios </h5>\r\n      <div class=\"col s4 \">\r\n        <img class=\"responsive-img\" src=\"assets/unal.png\">\r\n      </div>\r\n      <div class=\"col s8\">\r\n        <p> Ingeniería de Sistemas y Computación - Universidad Nacional de Colombia</p>\r\n      </div>\r\n    </div>\r\n    <div class=\"row\">\r\n      <h5>Cursos certificados </h5>\r\n      <div class=\"col s4 \">\r\n        <img class=\"responsive-img\" src=\"assets/j33.jpg\">\r\n      </div>\r\n      <div class=\"col s8\">\r\n        <p> Curso programación web en java J2EE</p>\r\n      </div>\r\n    </div>\r\n\r\n  </div>\r\n  <div id=\"test-swipe-2\" class=\"col s12 card\">\r\n    <h4>Idiomas</h4>\r\n    <h5>Ingles </h5>\r\n    <div class=\"col s4\">\r\n      <a href=\"https://www.efset.org/english-score/\" target=\":_blank\">\r\n      <img class=\"responsive-img\" src=\"assets/efset.PNG\" style=\" width: 80%; height: auto;\" class=\"center\">\r\n      </a>\r\n    </div>\r\n    <div class=\"col s8\">\r\n    <ul>\r\n      <li><b>Dominio del idioma hablado:</b> Alto</li>\r\n      <li><b>Dominio del idioma escrito:</b> Alto</li>\r\n    </ul>\r\n    </div>\r\n  </div>\r\n  </div>\r\n</div>\r\n"
...
module.exports = "<nav-bar></nav-bar>\r\n<div id=\"test1\" class=\"col s12\"><about></about></div>\r\n<div id=\"test2\" class=\"col s12\"><skills></skills></div>\r\n<div id=\"test3\" class=\"col s12\"><proyects></proyects></div>\r\n<foter></foter>\r\n"
...
module.exports = "<footer class=\"page-footer green lighten-1\">\r\n  <div class=\"container\">\r\n    <div class=\"row\">\r\n      <div class=\"col l6 s12\">\r\n        <h5 class=\"white-text\">Portafolio hecho desde cero</h5>\r\n        <p class=\"grey-text text-lighten-4\">Portafolio contruido con Angula y Materializecss para facil expancio.</p>\r\n      </div>\r\n      <div class=\"col l4 offset-l2 s12\">\r\n        <h5 class=\"white-text\">Links</h5>\r\n        <ul>\r\n          <li><a class=\"grey-text text-lighten-3\" href=\"\">Portafolio en Github</a></li>\r\n          <li><a class=\"grey-text text-lighten-3\" href=\"http://materializecss.com/\" target=\"_blank\">Materializecss</a></li>\r\n          <li><a class=\"grey-text text-lighten-3\" href=\"http://konpa.github.io/devicon/\" target=\"_blank\">Iconos</a></li>\r\n        </ul>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"footer-copyright\">\r\n    <div class=\"container\">\r\n      © 2017 Sergio Alejandro Diaz Pinilla\r\n    </div>\r\n  </div>\r\n</footer>\r\n"
...
module.exports = "\r\n<nav class=\"nav-extended  green lighten-1\">\r\n  <div class=\"nav-wrapper\" style=\"padding-bottom: 150px\">\r\n    <a href=\"#\" class=\"brand-logo center\" >\r\n      <img class=\"circle responsive-img\" src=\"assets/sunny.png\">\r\n    </a>\r\n\r\n  </div>\r\n  <div class=\"nav-content row\">\r\n    <ul class=\"tabs tabs-transparent\">\r\n      <li class=\"tab col l4 s4 m4\"><a  class=\"active\" href=\"#test1\">Sobre mi</a></li>\r\n      <li class=\"tab col l4 s4 m4\"><a href=\"#test2\">Conocimientos</a></li>\r\n      <li class=\"tab col l4 s4 m4\"><a href=\"#test3\">Experiencia y Proyectos</a></li>\r\n    </ul>\r\n  </div>\r\n</nav>\r\n\r\n"
...
module.exports = "\r\n<div class=\"col s12 m10 push-m1\">\r\n    <div class=\"card\">\r\n      <div class=\"card-image\">\r\n        <img src=\"{{proyect.imgsrc}}\">\r\n        <span class=\"card-title black\">{{proyect.name}}</span>\r\n      </div>\r\n      <div class=\"card-content\">\r\n        <h6>{{proyect.date}}</h6>\r\n        <p>{{proyect.description}}</p>\r\n      </div>\r\n      <div class=\"card-action\">\r\n        <div class=\"row\">\r\n          <div *ngFor=\"let tec of proyect.tecnologies\">\r\n            <span  class=\"col s2 m2 new badge  {{getColor(tec)}}\" data-badge-caption=\"\">{{tec}}</span>\r\n          </div>\r\n        </div>\r\n        <a target=\"_blank\" href=\"{{proyect.link}}\"> Link</a>\r\n        <a target=\"_blank\" href=\"{{proyect.github}}\"> Codigo</a>\r\n      </div>\r\n    </div>\r\n</div>\r\n\r\n"
...
module.exports = "<div class=\"row\">\r\n<div class=\"col s12 m10 push-m1\">\r\n  <h3>Experiencia</h3>\r\n  <div class=\"row\">\r\n    <div class=\"col s12 m12\">\r\n      <div class=\"card blue-grey darken-1\">\r\n        <div class=\"card-content white-text\">\r\n          <span class=\"card-title\">Desarrollador Front-End</span>\r\n          <p>\r\n            Desarrollador temporal en un proyecto de\r\n            una pequeña empresa de desarrollo de software llamada GeekCore.\r\n          </p>\r\n          <b class=\"orange-text\">Tiempo:</b><p>1 mes</p>\r\n          <b class=\"orange-text\">Actividad:</b><p>Desarrollo de componentes de front-end en AngularJS para un proyecto de la empresa.</p>\r\n        </div>\r\n        <div class=\"card-action\">\r\n          <a href=\"http://www.informacion-empresas.co/Empresa_GEEKCORE-SAS.html\">Informacion empresa.</a>\r\n          </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n<div class=\"row\">\r\n    <div class=\"col s12 m12\">\r\n      <div class=\"card blue-grey darken-1\">\r\n        <div class=\"card-content white-text\">\r\n          <span class=\"card-title\">Ingeniero I desarrollo de productos</span>\r\n          <p>\r\n           Desarrollador en el equipo de SISEC de la compañia Olimpia.\r\n          </p>\r\n          <b class=\"orange-text\">Tiempo:</b><p>8 meses</p>\r\n          <b class=\"orange-text\">Actividad:</b>\r\n          <p>\r\n          Trabajando en aplicaciones .NET, base de datos SQL server y apliaciones\r\n          Web MVC con front end en AngularJS.\r\n          </p>\r\n        </div>\r\n        <div class=\"card-action\">\r\n          <a href=\"https://www.olimpiait.com/sisec.html\">Informacion empresa.</a>\r\n          </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n\r\n  <h3>Proyectos academicos y personales</h3>\r\n  <p>Para ver todos los proyectos que e hecho mirar en este <a target=\"_blank\" href=\"https://github.com/seradiazpin?tab=repositories\">link</a></p>\r\n</div>\r\n\r\n<div class=\"row\" *ngFor=\"let pro of proyects\">\r\n  <proyect [proyect]=\"pro\" ></proyect>\r\n</div>\r\n</div>\r\n"
...
module.exports = "<div style=\"margin-top: 30px;\" class=\"col s2 m2 waves-effect center  tooltipped\" data-position=\"bottom\" data-delay=\"50\" [attr.data-tooltip]=\"skill.description\">\r\n\r\n  <h6><b>{{skill.name}}</b></h6>\r\n  <svg viewBox=\"0 0 128 128\">\r\n    <path [attr.fill]=\"getColor(skill.name)\" [attr.d]=\"skill.simbol\"></path>\r\n  </svg>\r\n  <h6>{{skill.time}}</h6>\r\n</div>\r\n<div class=\"col s1 m1\"></div>\r\n"
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col s12 m8 push-m2\">\r\n<h1> Mis conocimientos</h1>\r\n<p>\r\n  Mis conocimientos se encuentran en la siguiente manera\r\n</p>\r\n<ul class=\"collapsible\" data-collapsible=\"accordion\">\r\n  <li>\r\n    <div class=\"collapsible-header\"><i class=\"material-icons\">code</i>Lenguajes</div>\r\n    <div class=\"collapsible-body\">\r\n      <div class=\"row\">\r\n        <skill *ngFor=\"let sk of lskills\" [skill]=\"sk\" ></skill>\r\n      </div>\r\n    </div>\r\n\r\n  </li>\r\n  <li>\r\n    <div class=\"collapsible-header\"><i class=\"material-icons\">web</i>Front-End</div>\r\n    <div class=\"collapsible-body\">\r\n      <div class=\"row\">\r\n      <skill *ngFor=\"let sk of fskills\" [skill]=\"sk\" ></skill>\r\n      </div>\r\n    </div>\r\n\r\n  </li>\r\n  <li>\r\n    <div class=\"collapsible-header\"><i class=\"material-icons\">storage</i>Back-End</div>\r\n    <div class=\"collapsible-body\">\r\n      <div class=\"row\">\r\n        <skill *ngFor=\"let sk of bskills\" [skill]=\"sk\" ></skill>\r\n      </div>\r\n    </div>\r\n  </li>\r\n  <li>\r\n    <div class=\"collapsible-header\"><i class=\"material-icons\">whatshot</i>Herramientas</div>\r\n    <div class=\"collapsible-body\">\r\n      <div class=\"row\">\r\n        <skill *ngFor=\"let sk of tskills\" [skill]=\"sk\" ></skill>\r\n      </div>\r\n    </div>\r\n  </li>\r\n</ul>\r\n  </div>\r\n</div>\r\n"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mockproyects__ = __webpack_require__(93);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProyectsService; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProyectsService = (function () {
    function ProyectsService() {
    }
    ProyectsService.prototype.getData = function () {
        return Promise.resolve(__WEBPACK_IMPORTED_MODULE_1__mockproyects__["a" /* PROYECTS */]);
    };
    ;
    ProyectsService.prototype.getHero = function (id) {
        return this.getData()
            .then(function (heroes) { return heroes.find(function (hero) { return hero.id === id; }); });
    };
    ;
    return ProyectsService;
}());
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mockskills__ = __webpack_require__(97);
...
var SkillsService = (function () {
    ...
    SkillsService.prototype.getFrontData = function () {
        return Promise.resolve(__WEBPACK_IMPORTED_MODULE_1__mockskills__["a" /* FRONTSKILLS */]);
    };
    ;
    SkillsService.prototype.getBackData = function () {
        return Promise.resolve(__WEBPACK_IMPORTED_MODULE_1__mockskills__["b" /* BACKSKILLS */]);
    };
    ;
    SkillsService.prototype.getToolsData = function () {
        return Promise.resolve(__WEBPACK_IMPORTED_MODULE_1__mockskills__["c" /* TOOLS */]);
    };
    ;
    SkillsService.prototype.getLangData = function () {
        return Promise.resolve(__WEBPACK_IMPORTED_MODULE_1__mockskills__["d" /* LANGUAGES */]);
    };
    ;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__about_component_about_component__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__proyects_component_proyects_component__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__skills_component_skills_component__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__footer_component_foter_component__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__nav_bar_component_nav_bar_component__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__proyects_component_proyect_component_proyect_service__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__proyects_component_proyect_component_proyect_component__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__skills_component_skill_component_skill_service__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__skills_component_skill_component_skill_component__ = __webpack_require__(98);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__about_component_about_component__["a" /* AboutComponent */],
            __WEBPACK_IMPORTED_MODULE_6__proyects_component_proyects_component__["a" /* ProyectsComponent */],
            __WEBPACK_IMPORTED_MODULE_7__skills_component_skills_component__["a" /* SkillsComponent */],
            __WEBPACK_IMPORTED_MODULE_8__footer_component_foter_component__["a" /* FoterComponent */],
            __WEBPACK_IMPORTED_MODULE_9__nav_bar_component_nav_bar_component__["a" /* NavBarComponent */],
            __WEBPACK_IMPORTED_MODULE_11__proyects_component_proyect_component_proyect_component__["a" /* ProyectComponent */],
            __WEBPACK_IMPORTED_MODULE_13__skills_component_skill_component_skill_component__["a" /* SkillComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_10__proyects_component_proyect_component_proyect_service__["a" /* ProyectsService */], __WEBPACK_IMPORTED_MODULE_12__skills_component_skill_component_skill_service__["a" /* SkillsService */]],
...
//# sourceMappingURL=foter.component.js.map
...
//# sourceMappingURL=mockproyects.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__proyect__ = __webpack_require__(95);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProyectComponent; });
/**
 * Created by usuario on 09/06/2017.
 */
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var ProyectComponent = (function () {
    function ProyectComponent() {
    }
    ProyectComponent.prototype.getColor = function (name) {
    ...
    return ProyectComponent;
}());
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__proyect__["a" /* Proyect */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__proyect__["a" /* Proyect */]) === "function" && _a || Object)
], ProyectComponent.prototype, "proyect", void 0);
ProyectComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
        selector: 'proyect',
...
var _a;
//# sourceMappingURL=proyect.component.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Proyect; });
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__proyect_component_proyect_service__ = __webpack_require__(50);
...
var ProyectsComponent = (function () {
    function ProyectsComponent(proyectService) {
        this.proyectService = proyectService;
    }
    ProyectsComponent.prototype.ngOnInit = function () {
        this.getProyects();
    };
    ProyectsComponent.prototype.getProyects = function () {
        var _this = this;
        this.proyectService.getData().then(function (proyects) { return _this.proyects = proyects; });
    };
    return ProyectsComponent;
}());
ProyectsComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
        selector: 'proyects',
        template: __webpack_require__(166)
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__proyect_component_proyect_service__["a" /* ProyectsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__proyect_component_proyect_service__["a" /* ProyectsService */]) === "function" && _a || Object])
], ProyectsComponent);
...
var LANGUAGES = [
    ...
    },
    {
        ...
        time: "1 año",
        description: "Experiencia básica en programación en el lenguaje C++."
    },
    {
        name: "C#",
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__skill__ = __webpack_require__(99);
...
var SkillComponent = (function () {
    ...
    SkillComponent.prototype.getColor = function (name) {
        switch (name.toUpperCase()) {
            case "CSS":
                return "red";
            case "HTML":
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__skill__["a" /* Skill */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__skill__["a" /* Skill */]) === "function" && _a || Object)
